 ...
 * 
 * @title: TQuartzJob.java
 * @package org.platform.core.system.entity
 * @author leise
 * @date 2016年7月6日 下午7:01:42
 * @version v1.00
...
/**
 * @classname: TQuartzJob
 * @description: TODO(这里用一句话描述这个类的作用)
 */
@Table("T_QUARTZ_JOB")
public class TQuartzJob extends BaseEntity {

    /**
     * @fields serialVersionUID : 串行号
     */
    private static final long serialVersionUID = 4347483697652117592L;
